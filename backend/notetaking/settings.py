...
SECRET_KEY = 'django-insecure-9o8hj($wwn(wx)7bma+h0k^0ysf=j)yzb*_1%si5uqo9p=5z#x'
...
SPECTACULAR_SETTINGS = {
    ...
    'SWAGGER_UI_FAVICON_HREF': 'https://cdn.jsdelivr.net/npm/swagger-ui-dist@5.10.3/favicon-32x32.png',
    ...
    'TAGS': [
        ...
        {'name': 'Notebooks', 'description': 'Notebook management endpoints'},
        {'name': 'Blocks', 'description': 'Block management within notebooks'},
    ],
}
